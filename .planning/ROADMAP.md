...
**Plans:** 6 plans
Plans:
- [ ] 08-01-PLAN.md — Test infrastructure: RAF mock, Section aria-hidden, Button CVA fix
- [ ] 08-02-PLAN.md — ConfirmDialog i18n: replace hardcoded defaults with t()
- [ ] 08-03-PLAN.md — Fix remaining 14 failing tests (ConfigPanel, ControlPanelPage, SshConnectForm, FoundStep, ProcessFilterSection)
- [ ] 08-04-PLAN.md — i18n audit: remove hardcoded fallbacks from EmptyState, Select, DropOverlay
- [ ] 08-05-PLAN.md — UI fixes: ServerTabs pill indicator, disconnect a11y, auth contrast, visual softness
- [ ] 08-06-PLAN.md — Screen specs documentation for all Pro screens
...
| 8. Stabilization | v3.1 | 0/6 | Planned | - |
