...
**File:** `gui-pro/.storybook/main.ts:14`
...
**File:** `gui-pro/.storybook/tauri-mocks/api-event.ts:2`
**File:** `gui-pro/.storybook/tauri-mocks/api-window.ts:9-10`
...
**File:** `gui-pro/.storybook/tauri-mocks/api-app.ts:3`
...
**File:** `gui-pro/.storybook/main.ts:21`
