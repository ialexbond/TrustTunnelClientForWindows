...
**File:** `gui-app/src/components/ControlPanelPage.tsx:84`
...
**File:** `gui-app/src/components/server/LogsSection.tsx:65`
...
**File:** `gui-app/src/components/server/CertSection.tsx:180`
...
**File:** `gui-app/src/components/server/Fail2banSection.tsx:124`
...
**File:** `gui-app/src/components/ServerTabs.tsx:33-39`
...
**File:** `gui-app/src/components/ServerSidebar.tsx:43-74`
...
**File:** `gui-app/src/components/ServerSidebar.tsx:68-73`
...
**File:** `gui-app/src/components/server/CertSection.tsx:140`
...
**File:** `gui-app/src/shared/ui/Select.tsx:138-142`
