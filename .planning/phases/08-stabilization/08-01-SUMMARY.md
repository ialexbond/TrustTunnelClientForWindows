...
- **Files modified:** `gui-pro/src/shared/ui/Section.tsx`
...
- `gui-pro/src/test/setup.ts` содержит `global.requestAnimationFrame` ✓
- `gui-pro/src/test/setup.ts` содержит `global.cancelAnimationFrame` ✓
- `gui-pro/src/shared/ui/Section.tsx` содержит `aria-hidden={!showContent}` ✓
- `gui-pro/src/shared/ui/Section.tsx` содержит `visibility` ✓
- `gui-pro/src/shared/ui/Section.test.tsx` содержит `not.toBeVisible()` ✓
- `gui-pro/src/shared/ui/Button.test.tsx` содержит `h-10` ✓
