...
- [x] ~~Автообновление приложения~~ (реализовано в v1.2.1)
- [x] ~~Kill Switch~~ (реализовано в v1.2.0)
- [x] ~~Split tunneling в GUI~~ (реализовано в v1.2.0 — маршрутизация доменов)
- [ ] Поддержка нескольких серверов / профилей
- [ ] Маршрутизация по приложениям (WFP)
