...
2. Напишите на **you@example.com** с темой `[SECURITY] TrustTunnel Client — <краткое описание>`.
...
- **Defense in depth** — frontend-валидация + backend-санитизация (см. `gui-pro/src-tauri/src/ssh/sanitize.rs`)
...
**Мониторинг:**
```bash
cd gui-pro/src-tauri && cargo audit
```
