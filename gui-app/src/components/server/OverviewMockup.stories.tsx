...
/* ═══════════════════════════════════════════════════════
   Phase 13 Overview Mockup v5
   Row 1: Status (2fr) + Protocol (2fr) + Users (1fr)
   Row 2: Security (1fr) + Speed (1fr)
   Row 3: Load (full width)

   Design rules:
   - Titles: text-xl (20px) — visually dominant
   - Content: text-sm (12px) — subordinate to title
   - Values: text-base (14px) semibold — readable but smaller than title
   - Big numbers: clamp() adaptive
   ═══════════════════════════════════════════════════════ */
  ...
  return (
    <div className="flex items-center justify-between mb-3">
      <div className="flex items-center gap-2.5">
        ...
        <span className="text-xl font-[var(--font-weight-semibold)]" style={primary}>{title}</span>
      </div>
      ...
      <div className="grid gap-3" style={{ gridTemplateColumns: "2fr 2fr 1fr" }}>
        ...
        <div className={card} style={cardBg}>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center justify-between">
              <span className="text-xs" style={muted}>Страна</span>
        ...
        <div className={`${card} flex flex-col`} style={cardBg}>
          ...
          <p className="text-lg font-[var(--font-weight-semibold)] flex-1 flex items-center" style={primary}>TrustTunnel</p>
        ...
        <div className={`${card} flex flex-col`} style={cardBg}>
          ...
          <div className="flex-1 flex items-center justify-center">
            <span style={{ fontSize: "clamp(2rem, 6vw, 4rem)", fontWeight: 600, lineHeight: 1, ...primary }}>2</span>
          </div>
        </div>
      </div>
      ...
      <div className={card} style={cardBg}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xl font-[var(--font-weight-semibold)]" style={primary}>Нагрузка</span>
          </div>
    ...
    >
      <div className="grid gap-3" style={{ gridTemplateColumns: "2fr 2fr 1fr" }}>
        ...
        <div className={`${card} flex flex-col`} style={cardBg}>
          <CardTitle icon={<Users className="w-5 h-5" />} title="Пользователи" clickable />
          <div className="flex-1 flex items-center justify-center">
            <span style={{ fontSize: "clamp(2rem, 6vw, 4rem)", fontWeight: 600, lineHeight: 1, ...primary }}>5</span>
          </div>
        </div>
      </div>
