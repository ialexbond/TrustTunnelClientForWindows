    ...
    <div className="flex-1 flex items-center justify-center p-6 overflow-auto">
      <div className="max-w-lg w-full space-y-6">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="p-4 rounded-2xl bg-cyan-500/20 shadow-lg shadow-cyan-500/10">
            <Shield className="w-12 h-12 text-cyan-400" />
          </div>
          <h1 className="text-xl font-bold tracking-wide">
            TrustTunnel
            <span className="ml-2 text-xs font-semibold text-cyan-400 bg-cyan-400/15 px-1.5 py-0.5 rounded">LIGHT</span>
          </h1>
        ...
        <div className="bg-surface-900/50 rounded-xl border border-white/5 p-5 space-y-3">
          ...
          <p className="text-xs text-gray-400 leading-relaxed">
            TrustTunnel Light — облегчённый VPN-клиент для Windows.
            Подключение к серверу одним нажатием без мастера настройки.
          </p>
